<template>  
    <div ref="chartContainer" style="height: 340px; width: 100%;"></div>  
  </template>  
  ...
  export default {  
    ...
    methods: {  
      initChart() {  
        const chartDom = this.$refs.chartContainer; // 获取 DOM 元素  
  ...
  '22:00', '22:15', '22:30'  
          ...
          visualMap: {  
            ...
            pieces: [  
              { lte: 6, color: 'green' },  
              { gt: 6, lte: 8, color: 'green' },  
              { gt: 8, lte: 14, color: 'green' },  
              { gt: 14, lte: 17, color: 'green' },  
              { gt: 17, color: 'green' }  
            ]  
          },  
          series: [  
            {  
              ...
              type: 'line',  
              smooth: true,  
              data:[35, 12, 67, 4, 56, 93, 18, 21, 65, 88, 32, 1, 77, 12, 56, 41, 81, 54, 45, 2, 90,  
 37, 18, 60, 39, 75, 13, 19, 98, 30, 84, 7, 92, 73, 99, 8, 90, 48, 4, 67, 92, 15,  
 27, 62, 86, 77, 35, 92, 59, 93, 74, 84, 29, 37, 8, 46, 11, 34,29, 37, 8, 46, 11, 34,29, 37, 8, 46, 11, 34], 
                itemStyle:{
                            color:'yellowgreen',
                        },
              markArea: {  
